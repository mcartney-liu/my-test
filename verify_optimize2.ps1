...
checks = [
    ...
    ('risk-health-grid HTML', "class=\"risk-health-grid\" style=\"margin"),
    ...
    ('卡片底部间距', '.card-footer{display:flex;justify-content:space-between;align-items:center;margin-top:10px;padding-left:8px;gap:8px}'),
]
